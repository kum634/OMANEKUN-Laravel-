...
<body>
  ...
  @endif
  <div class="form_area">
    <form id="form1" name="form1" method="get" action="{{ url('delete_seach_result') }}">
  ...
  <div class="result">
    ...
    <table class="seach_result">
      ...
      <tr>
        ...
        <td>
          <form action="{{ url('delete_details') }}" method="get" name="form{{ $maintenance_request_table->ID }}" id="form{{ $maintenance_request_table->ID }}">
            ...
            <input class="small_btn" type="submit" name="submit_{{ $maintenance_request_table->ID }}" id="submit_{{ $maintenance_request_table->ID }}" value="削除"/>
          </form>
        </td>
      </tr>
      @endforeach
